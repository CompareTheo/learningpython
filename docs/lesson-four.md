...
>Using a while loop and an if statement, write a function named name_add which appends all the elements in a list to a new list unless the element is an empty string: "".
